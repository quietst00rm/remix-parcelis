    ...
    <section className="bg-ds-neutral-50" style={{ padding: "96px 0" }}>
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        <div className="max-w-[680px] mx-auto">
          <div className="bg-white rounded-[20px] p-10 md:p-12 shadow-[0_8px_30px_rgba(0,0,0,0.06)] relative">
            {/* Decorative quote mark */}
            <span
              className="absolute top-6 left-8 font-heading text-[80px] leading-none text-ds-teal select-none pointer-events-none"
              style={{ opacity: 0.15 }}
              aria-hidden="true"
            >
              &ldquo;
